...
std::ostream &operator<<( std::ostream& os, const COM_exception &ex) {
  os << "COM: " << (ex.ierr<1000?"WARNING ":"ERROR ")
     << ex.ierr << ": ";
  std::string msg;
  switch (ex.ierr) {
  ...
  case COM_ERR_WAS_INITIALIZED:    
    msg = "COM was already initialized"; break;
  case COM_ERR_WASNOT_INITIALIZED: 
    msg = "COM was not initialized"; break;
  ...
  case COM_ERR_DATAITEM_NOTEXIST: 
    msg = "DataItem does not exist"; break;
  ...
  case COM_ERR_INVALID_DATAITEM_NAME: 
    msg = "Invalid dataitem name"; break;

  case COM_ERR_DATAITEM_INITIALIZED: 
    msg = "DataItem was already intialized"; break;
  case COM_ERR_DATAITEM_NOT_ALLOCATED: 
    msg = "DataItem was not allocated by COM"; break;
  ...
  case COM_ERR_DATAITEM_ALLOCATED: 
    msg = "DataItem has already been allocated by COM"; break;
  ...
  case COM_ERR_CHANGE_INHERITED:
    msg = "Trying to change the meta-data of an inherited dataitem"; break;
  case COM_ERR_RESIZE:
    msg = "Trying to resize an inherited or user-allocated dataitem"; break;
  case COM_ERR_INHERIT_MESH_LATE:
    msg = "Mesh must be used/cloned before creating any dataitem"; break;
  ...
  case COM_ERR_APPEND_ARRAY:
    msg = "Appending array is supported only for window and pane dataitems without ghosts"; break;
  case COM_UNKNOWN_ERROR:
  default: 
    msg = "Unknow error"; 
  }

  os << msg << "\nCOM: Error encountered when processing " 
     << ex.msg << std::endl << "COM: ";
  return os;
}
