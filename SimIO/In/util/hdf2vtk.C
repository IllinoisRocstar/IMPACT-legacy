...
void COM_print_window(const std::string& wName, const std::string& timeStr,
                      const std::string& file_in, bool mesh_only)
{
  ...
  int nAttrs;   // Number of dataitems
  char* attrStr;  // names of dataitems separated by spaces
...
int main(int argc, char* argv[])
{
  ...
  int IN_all = COM_get_dataitem_handle((win_in + ".all").c_str());
