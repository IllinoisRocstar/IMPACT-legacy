...
int main(int argc, char *argv[]) {
  ...
  COM_new_dataitem("str.coor", 'n', COM_DOUBLE, 3, "m");
  COM_new_dataitem("str.npress", 'n', COM_DOUBLE, 3, "Pa");
  COM_new_dataitem("str.fpress", 'e', COM_DOUBLE, 3, "Pa");
  ...
  COM_new_window("tri");
  COM_new_dataitem("tri.coor", 'n', COM_DOUBLE, 3, "m");
  COM_new_dataitem("tri.npress", 'n', COM_DOUBLE, 3, "Pa");
  COM_new_dataitem("tri.fpress", 'e', COM_DOUBLE, 3, "Pa");
  ...
  int tri_mesh = COM_get_dataitem_handle( "tri.mesh");
  int str_mesh = COM_get_dataitem_handle( "str.mesh");
  ...
  if ( comm_size == 1) {
    ...
    COM_call_function( RFC_write, &tri_mesh, &str_mesh, "tri", "str", "CGNS");
  ...
  if ( argc>7) {
    ...
    int tri_coor = COM_get_dataitem_handle( "tri.coor");
    int str_coor = COM_get_dataitem_handle( "str.coor");
    ...
    int tri_npress = COM_get_dataitem_handle( "tri.npress");
    int str_fpress = COM_get_dataitem_handle( "str.fpress");
    ...
    int tri_fpress = COM_get_dataitem_handle( "tri.fpress");
    int str_npress = COM_get_dataitem_handle( "str.npress");
